...
I believe in meaningful transitions
I'm such a good dev that I fixed my own bugs as well
...
**coffeecoach.app**
A full-stack app that helps people improve their coffee brewing through structured feedback and data-driven suggestions. I built it because I was personally trying to get better at brewing and realized most advice online is scattered and inconsistent — so I collected high-quality data and built a decision tree to guide brewers through it. *(64 users within a week, zero paid promotion)*
...
## About me
**Photo grid:**
- `assets/mountains-dog.jpg` *(rename your dog+Himalayas photo to this)*
- `assets/chess.jpg` — chess board
- `assets/football.jpg` — boots on turf
- `assets/cb.jpg` — chole bhature
- `assets/surgery.jpg` — ACL recovery
...
## Footer
Built by Hardeep Singh · hardeep.cv
X · GitHub · LinkedIn
